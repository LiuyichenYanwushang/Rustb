...
pub use types::{SimplexDiagnostics, TrackedSimplex, VertexKernel, SIMPLEX_GAP_TOL};
...
pub use kernel::{
    eval_berry_kernel, eval_optical_kernel, fermi, fermi_deriv,
    quadrature_berry_simplex, quadrature_dipole_simplex, quadrature_optical_simplex,
};

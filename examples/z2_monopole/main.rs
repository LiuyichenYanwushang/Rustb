...
fn main(){
    ...
    model.add_hop(-delta*3.0_f64.sqrt(),3,3,&array![0,0,0],1);
    model.add_hop(-delta,3,3,&array![0,0,0],2);
    model.add_hop(delta,4,4,&array![0,0,0],2);

    /*
    model.add_hop(-delta*3.0_f64.sqrt(),1,1,&array![0,0,0],1);
    model.add_hop(delta,1,1,&array![0,0,0],2);
    model.add_hop(delta*3.0_f64.sqrt(),2,2,&array![0,0,0],1);
    model.add_hop(delta,2,2,&array![0,0,0],2);
    model.add_hop(-delta,5,5,&array![0,0,0],2);
    */

    model.add_hop(t1,0,1,&array![0,0,0],0);
    model.add_hop(t1,0,2,&array![0,0,0],0);
    model.add_hop(t1,0,5,&array![0,-1,0],0);
    model.add_hop(t1,1,4,&array![0,0,0],0);
    model.add_hop(t1,1,3,&array![1,-1,0],0);
    model.add_hop(t1,2,3,&array![0,0,0],0);
    model.add_hop(t1,2,4,&array![-1,0,0],0);
    model.add_hop(t1,3,5,&array![0,0,0],0);
    model.add_hop(t1,4,5,&array![0,0,0],0);
